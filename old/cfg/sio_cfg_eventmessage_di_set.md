...
Configures a custom OSC message to be sent to subscribers when a Node's digital input state changes.  
...
## Effects
Stores a custom OSC message in the node configuration. When the specified digital input channel changes to the specified state, the custom message will be sent to all registered subscribers.
